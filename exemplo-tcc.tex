...
Suporte a Cache/Proxy   & Parcial                                                                                     & sim                                                 & sim                                                                                                             & sim                                                                   \\
Qualidade de Serviço    & 3 níveis: QOS 0 - no máximo uma vez; QOS 1 - Pelo menos uma vez; QOS 2 - Exatamente uma vez & 2 Níveis: QOS 0; QOS 1.                             & 2 Níveis: QOS 0; QOS 1.                                                                                         & Limitado via TCP                                                      \\
Protocolo de Transporte & TCP                                                                                         & UDP, SCTP                                           & TCP, SCTP                                                                                                       &                                                                       \\
Segurança               & TLS/SSL                                                                                     & DTLS, IPSec                                         & TLS/SSL, IPSec                                                                                                  & TCP                                                                   \\
Porta Padrão            & 1883 TLS / 8883 SSL                                                                         & 5683 UDP, 5684 DTLS                                 & 5671 TLS                                                                                                        & 80 TLS / 443 SSL                                                      \\
Codificação             & Binário                                                                                     & Binário                                             & Binário                                                                                                         & Texto                                                                
\end{tabular}%
}
\caption{}
\label{tab:my-table}
